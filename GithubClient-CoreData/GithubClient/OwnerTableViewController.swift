...
class OwnerTableViewController: FetchedResultsTableViewController {

    private var fetchedResultsController: NSFetchedResultsController<Owner>?
    ...
    private func initializeFetchedResultsController() {
        if let context = container?.viewContext {
            ...
            do {
                ...
                fatalError("Failed to initialize fetchResultController")
            }
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let ownerMO = fetchedResultsController?.object(at: indexPath) {
            cell.textLabel?.text = ownerMO.name
        }
